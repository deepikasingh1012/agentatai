...
//       try {
//         while (hasMore) {
//           const res = await getInquiryByClientId(clientId, page, 100); // Assuming 100 per page max
...
//     const counts = { open: 0, close: 0, inProgress: 0 };
...
//       else if (status === "closed") counts.close += 1;
...
//           <span>🔴 Closed: {statusCounts.close}</span>
  ...
  return (
    <div className="container mt-4">
      <div className="row mb-3">
        ...
        <div className="col-md-3  d-flex align-items-end">       
            <span className="badge bg-danger text-light me-5 p-2 fs-6">
              Closed: {statusCounts.Closed}
            </span>
            <span className="badge bg-warning text-light me-5 p-2 fs-6">

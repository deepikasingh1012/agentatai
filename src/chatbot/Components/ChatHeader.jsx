...
const ChatHeader = ({ handleBackClick, handleExitPrompt, sessionId }) => {
    return (
        <div className="d-flex align-items-center justify-content-between p-2 bg-primary text-white">
            ...
            <div className="d-flex align-items-center gap-2">
                ...
                <span className="fw-bold">ATai</span>
            </div>
